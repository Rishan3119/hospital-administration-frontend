      ...
      <div id='about' className="container sm:-mt-[70px]  mx-auto ">
        <div className="f-all flex flex-wrap justify-between ">
          ...
          <div className='q-f'>
            ...
            <ul className="space-y-2">
              <li><a href="/DH" className="hover:underline">Dashboard</a></li>
              <li><a href="/viewAppo" className="hover:underline">Appointments</a></li>
              <li><a href="/viewHistory" className="hover:underline">History</a></li>
            </ul>
          </div>
