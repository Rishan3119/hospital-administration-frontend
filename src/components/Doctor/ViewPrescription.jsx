            ...
            <tbody>
              {prescription.map(item => (
                <tr key={item.id}>
                  ...
                  <td className='p-2 border-collapse border-2 border-gray-300 text-center bg-gray-200'>
                        {department.find(dep => dep.id === item.dep)?.department }
                        </td>
                  <td className='p-3 border-collapse border-2 border-gray-300 text-center bg-gray-200'>
                  {
                    medicines.map((itm)=>{
